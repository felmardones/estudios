...
public class Logic 
    ...
    /*
     * Return the Right Triangle Area
     *
     */
    ...
    /*
     * Calculate and Return the Right Triangle Area
     *
     */
    public static double rightTrianglePerimeter(double base, double height){
        //To get the right triangle perimeter, we have to get the size of hypotenuse
        //hypotenuse
        double h = Math.pow(base,2) + Math.pow(height,2);
        //perimeter
        double p = h + base + height;
        //Return the right triangle perimeter
        return p;
    }
